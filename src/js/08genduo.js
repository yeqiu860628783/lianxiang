...
$.get("./php/gettailist.php", function (data) {
    ...
    new Pagination(pagin, {
        ...
        change(num) {
            ...
            data.forEach(function (item) {
                str += `
                      <li>
                            <a class="imgA" href="${item.lianjie}">
                            ...
                            <div class="search_name">
                                <a href="${item.lianjie}" target="_blank">${item.tit}</a>
                            </div>
                            <div class="search_mes">
                                <a href="${item.lianjie}">${item.search}</a>
                            </div>
                            <div class="search_price">${item.price}</div>
                            <a class="duibi" href="${item.lianjie}">
                                <input type="checkbox">
                                <span>对比</span>
                            </a>
                        </li>
